...
const getItemsData = async (category) => {
   ...
   const res = await axios.get(
      `https://b11a11-server-side-dev-istiake.vercel.app/categorizePostItem/?category=${encodedCategory}`
   );
   return res.data;
};
...
const fetchSearchData = async (value) => {
   ...
   const res = await axios.get(
      `https://b11a11-server-side-dev-istiake.vercel.app/searchPostItem/?search=${encodedSearch}`
   );
   return res.data;
};
