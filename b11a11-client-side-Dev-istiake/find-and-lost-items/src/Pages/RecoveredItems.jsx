...
const getItemsData = async (category) => {
   ...
   const res = await axios.get(
      `https://b11a11-server-side-dev-istiake.vercel.app/categorizeRecoveredItems/?category=${encodedCategory}`
   );
   return res.data;
};
...
const fetchSearchData = async (value) => {
   ...
   const res = await axios.get(
      `https://b11a11-server-side-dev-istiake.vercel.app/searchRecoveredItems/?search=${encodedSearch}`
   );
   return res.data;
};
...
const RecoveredItems = () => {
   ...
   return (
      <div className="relative">
         <div class="custom-shape-divider-bottom-1750001144">
            <svg
               data-name="Layer 1"
