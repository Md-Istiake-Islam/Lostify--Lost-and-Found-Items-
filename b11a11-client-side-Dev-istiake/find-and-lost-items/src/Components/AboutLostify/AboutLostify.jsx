      ...
      <div className="container 2xl:max-w-7xl mx-auto">
         <div className="grid grid-cols-1 xl:grid-cols-2 w-full xl:h-[480px] gap-6 lg-gap-0">
            <div className="flex flex-col justify-center items-center xl:items-start  2xl:px-20">
               ...
               <h1 className="text-4.6xl lg:text-6xl !font-nunito text-[#235480] leading-16 lg:leading-19 lg:mt-2 mb-2 lg:mb-7 font-medium flex xl:flex-col gap-2">
                  Lost something?
                  <span className="font-medium !font-nunito">
                     Find it here…
                  </span>
               </h1>
               <p className="!font-nunito text-sm lg:text-lg font-light text-gray-700 lg:max-w-md leading-7 text-center xl:text-start">
