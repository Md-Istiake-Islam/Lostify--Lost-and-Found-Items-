      ...
      <div>
         <div className="card bg-base-100 w-full shadow-sm  p-6">
            ...
            <div className="card-body pb-2 pr-0.5 pl-3 ">
               <h2 className="card-title text-1xl lg:text-2xl mb-1 text-gray-700">
                  {title}
               </h2>
               ...
               <div className="flex gap-2 items-center w-full justify-between">
                  ...
                  <p className="flex items-center gap-2 text-xs lg:text-sm justify-end text-gray-500 pb-3 min-w-[32%]">
                     {" "}
